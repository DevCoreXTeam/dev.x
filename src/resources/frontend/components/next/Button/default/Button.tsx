...
type ButtonVariant = "neutral" | "inverse" | "outline" | "subtle" | "success" | "danger" | "link" | "disabled";
...
export default function Button({
  ...
  const variants = {
    ...
    link:
      "text-black underline underline-offset-4 hover:underline focus:ring-transparent dark:text-white dark:hover:text-gray-300",
    disabled:
